...
CREATE TABLE `aplicaciones_laboratorios` (
  ...
  `lab1` char(2) DEFAULT NULL,
  `lab2` char(2) DEFAULT NULL,
  `lab3` char(2) DEFAULT NULL,
  `lab4` char(2) DEFAULT NULL,
  `lab5` char(2) DEFAULT NULL,
  `lab6` char(2) DEFAULT NULL,
  `lab7` char(2) DEFAULT NULL,
  `lab8` char(2) DEFAULT NULL,
  `lab9` char(2) DEFAULT NULL,
  `lab10` char(2) DEFAULT NULL,
  `lab11` char(2) DEFAULT NULL,
  `lab12` char(2) DEFAULT NULL,
  `lab13` char(2) DEFAULT NULL,
  `lab14` char(2) DEFAULT NULL,
  `lab15` char(2) DEFAULT NULL,
...
INSERT INTO `aplicaciones_laboratorios` VALUES (20,'dfmkd','ewwe','no','no','no','no','si','no','no','no','no','no','no','no','si','no','no',1,'2023-03-15 00:42:05'),(21,'dfii3i3i4','dfii3i3i4','no','si','no','no','no','no','no','no','no','no','no','no','no','no','no',3,'2023-03-15 00:43:52'),(25,'vdnjdfjnvndjc','fdnjdfjnfd','no','si','si','no','no','no','no','no','no','no','no','si','no','no','no',1,'2023-03-15 00:54:38'),(26,'Lorem','Lorem','no','si','no','no','no','no','no','no','no','no','no','no','no','no','no',3,'2023-03-15 01:03:10'),(27,'fdmkdfmkdf','fdmkdfkmdfk','no','no','si','no','no','no','no','no','no','no','no','no','no','no','no',5,'2023-03-15 01:04:24'),(28,'dfmkdfkmfd','fdmkfdmkfd','no','si','no','no','no','no','no','no','no','no','no','no','no','no','no',1,'2023-03-15 01:05:46'),(29,'fjkdseo','fjkdseo','no','no','no','si','no','no','no','no','no','si','si','si','no','no','no',1,'2023-03-15 01:07:51'),(30,'dfkndfnkdf','dfnjkfdnjdf','no','no','no','no','no','no','no','no','no','no','no','no','si','no','no',2,'2023-03-15 01:12:20'),(31,'dfbjjdfb','fdnfdjndf','no','no','no','si','no','no','no','no','no','no','no','no','no','no','no',2,'2023-03-15 01:13:24'),(33,'vm','dfk','no','no','no','no','no','no','no','no','no','no','no','no','no','no','no',1,'2023-03-15 01:17:52'),(34,'fdk','fdk','no','no','no','no','si','no','no','no','no','no','no','no','no','no','no',1,'2023-03-15 01:18:29'),(35,'fdjidfjdf','fdjnkdfjndf','no','no','no','no','si','no','no','no','no','no','no','no','no','no','no',1,'2023-03-15 01:21:46'),(36,'dfnjdfjndjfn','fdnjdfbjndfjbdf','no','no','no','no','si','no','no','no','no','no','no','no','si','no','no',6,'2023-03-15 01:22:11');
...
INSERT INTO `laboratorios` VALUES (1,'LAB1','Laboratorio 1 Informática',85,5,'inactivo','#e00000'),(2,'LAB2','Laboratorio 2 Informatica',80,0,'activo','#f19898'),(3,'LAB3','Laboratorio 3 Informática',125,0,'activo','#f971ce'),(4,'LAB4','Laboratorio 4 Informática',30,0,'activo','#f312d5'),(5,'LAB5','Laboratorio 5 Informática',60,0,'activo','#9e62c6'),(6,'LAB6','Laboratorio 6 Informática',60,0,'activo','#6b099f'),(7,'LAB7','Laboratorio 7 Informática',0,0,'activo','#705d92'),(8,'LAB8','Laboratorio 8 Informática',88,0,'activo','#3a19e1'),(9,'LAB9','Laboratorio 9 Informática',50,0,'activo','#4d6fd5'),(10,'LAB10','Laboratorio 10 Informática',50,0,'activo','#42b0f5'),(11,'LAB11','Laboratorio 11 Informática',30,0,'activo','#61e5ff'),(12,'LAB12','Laboratorio 12 Informática',30,0,'activo','#a6f2cf'),(13,'LAB13','Laboratorio 13 Informática',65,0,'activo','#4fab61'),(14,'LAB14','Laboratorio 14 Informática',65,0,'activo','#54a800'),(15,'LAB15','Laboratorio 15 Informática',20,0,'activo','#fff700'),(17,'fjndfnkfd','dfnjdfjnjfndjnfddf',4989,0,'activo','#24695c');
...
-- Dump completed on 2023-03-14 19:24:36
