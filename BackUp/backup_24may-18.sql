...
--
-- Temporary view structure for view `vista_generarinformereservacionesprocesadas`
--

DROP TABLE IF EXISTS `vista_generarinformereservacionesprocesadas`;
/*!50001 DROP VIEW IF EXISTS `vista_generarinformereservacionesprocesadas`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_generarinformereservacionesprocesadas` AS SELECT 
 1 AS `idusuarios`,
 1 AS `idfacultad`,
 1 AS `idescuela`,
 1 AS `idlaboratorio`,
...
/*!50106 CREATE*/ /*!50117 DEFINER=`root`@`localhost`*/ /*!50106 EVENT `CambioEstadoReportesPlataformaResueltos` ON SCHEDULE EVERY 1 DAY STARTS '2023-05-18 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO CALL sp_CambioEstadoReportesPlataformaResueltos() */ ;;
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`root`@`localhost`*/ /*!50106 EVENT `CambioForzadoEstadoNuevaCredencialesUsuarios` ON SCHEDULE EVERY 1 DAY STARTS '2023-05-18 00:00:00' ON COMPLETION NOT PRESERVE ENABLE DO CALL sp_CambioEstadoCambioCredencialesUsuarios() */ ;;
/*!50003 SET time_zone             = @saved_time_zone */ ;;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;;
/*!50003 SET character_set_client  = @saved_cs_client */ ;;
/*!50003 SET character_set_results = @saved_cs_results */ ;;
...
/*!50003 SET @saved_time_zone      = @@time_zone */ ;;
/*!50003 SET time_zone             = 'SYSTEM' */ ;;
/*!50106 CREATE*/ /*!50117 DEFINER=`root`@`localhost`*/ /*!50106 EVENT `ExpirarCodigosRecuperacionCuentas` ON SCHEDULE EVERY 1 MINUTE STARTS '2023-05-18 00:03:00' ON COMPLETION NOT PRESERVE ENABLE DO CALL sp_CambioEstadoCodigoRecuperacionExpirado() */ ;;
/*!50003 SET time_zone             = @saved_time_zone */ ;;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;;
/*!50003 SET character_set_client  = @saved_cs_client */ ;;
/*!50003 SET character_set_results = @saved_cs_results */ ;;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_CambioEstadoCambioCredencialesUsuarios`()
BEGIN
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_CambioEstadoCodigoRecuperacionExpirado`()
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_CambioEstadoReportesPlataformaResueltos`()
...
BEGIN
	...
	SELECT meses.Mes, 
       ...
       COUNT(CASE WHEN reservaciones.estadoreservacion = 'cancelado' OR reservaciones.estadoreservacion = 'cancelada' THEN 1 END) AS Cancelado, 
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_ConsultaReservacionesProcesadasHistoricoDocentes`(IN `_ciclo` VARCHAR(8), IN `_idusuarios` INT)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_GenerarInformeReservacionesLaboratorios_EstadoAprobados` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_GenerarInformeReservacionesLaboratorios_EstadoAprobados`(IN `_ciclo` VARCHAR(8), IN `_idlaboratorio` INT)
BEGIN
	SELECT * FROM vista_generarinformereservacionesprocesadas WHERE estadoreservacion = "aprobado" AND ciclo = _ciclo AND idlaboratorio = _idlaboratorio;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_GenerarInformeReservacionesLaboratorios_EstadoCancelado` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_GenerarInformeReservacionesLaboratorios_EstadoCancelado`(IN `_ciclo` VARCHAR(8), IN `_idlaboratorio` INT)
BEGIN
	SELECT * FROM vista_generarinformereservacionesprocesadas WHERE estadoreservacion = "cancelado" OR estadoreservacion="cancelada" AND ciclo = _ciclo
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_GenerarInformeReservacionesLaboratorios_EstadoDenegado` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_GenerarInformeReservacionesLaboratorios_EstadoDenegado`(IN `_ciclo` VARCHAR(8), IN `_idlaboratorio` INT)
BEGIN
	SELECT * FROM vista_generarinformereservacionesprocesadas WHERE estadoreservacion = "denegado" AND ciclo = _ciclo AND idlaboratorio = _idlaboratorio;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_GenerarInformeReservacionesLaboratorios_EstadoTodos` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_GenerarInformeReservacionesLaboratorios_EstadoTodos`(IN `_ciclo` VARCHAR(8), IN `_idlaboratorio` INT)
BEGIN
	SELECT * FROM vista_generarinformereservacionesprocesadas WHERE ciclo = _ciclo AND idlaboratorio = _idlaboratorio;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_GenerarInformeReservaciones_EstadoAprobados` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_GenerarInformeReservaciones_EstadoAprobados`(IN `_ciclo` VARCHAR(8))
BEGIN
	SELECT * FROM vista_generarinformereservacionesprocesadas WHERE estadoreservacion = "aprobado" AND ciclo = _ciclo;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_GenerarInformeReservaciones_EstadoCancelado` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_GenerarInformeReservaciones_EstadoCancelado`(IN `_ciclo` VARCHAR(8))
BEGIN
	SELECT * FROM vista_generarinformereservacionesprocesadas WHERE estadoreservacion = "cancelado" OR estadoreservacion="cancelada" AND ciclo = _ciclo;
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_GenerarInformeReservaciones_EstadoDenegado` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_GenerarInformeReservaciones_EstadoDenegado`(IN `_ciclo` VARCHAR(8))
BEGIN
	SELECT * FROM vista_generarinformereservacionesprocesadas WHERE estadoreservacion = "denegado" AND ciclo = _ciclo;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_GenerarInformeReservaciones_EstadoTodos` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_GenerarInformeReservaciones_EstadoTodos`(IN `_ciclo` VARCHAR(8))
BEGIN
	SELECT * FROM vista_generarinformereservacionesprocesadas WHERE ciclo = _ciclo;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `sp_InformeReservacionesProcesadasPorCodigo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_InformeReservacionesProcesadasPorCodigo`(IN `_fechainicioreservacion` DATE, IN `_fechafinreservacion` DATE, IN `_codigoreservacion` VARCHAR(255))
BEGIN
SELECT subquery.codigounico_identificador, subquery.codigoreservacion, subquery.ciclo, subquery.nombrereservacion, subquery.seccionreservacion,
       CASE WHEN subquery.nombre_otrotitular = '' OR subquery.nombre_otrotitular IS NULL THEN CONCAT(usuarios.nombres, ' ', usuarios.apellidos)
            ELSE subquery.nombre_otrotitular
       END AS nombre_titular,
       MIN(subquery.fechainicio) AS fechainicio, MAX(subquery.fechafin) AS fechafin, 
       subquery.horainicioreservacion, subquery.horafinreservacion,
       DATEDIFF(MAX(subquery.fechafin), MIN(subquery.fechainicio)) + 1 AS total_practicas,
       SUM(subquery.usuarios_atendidos) AS usuarios_atendidos,
       subquery.aula_procedencia, subquery.idlaboratorio, subquery.mod1, subquery.mod2, subquery.mod3, subquery.mod4
FROM (
    SELECT codigounico_identificador, codigoreservacion, ciclo, nombrereservacion, seccionreservacion, nombre_otrotitular, MIN(fechainicioreservacion) AS fechainicio, MAX(fechafinreservacion) AS fechafin,
    horainicioreservacion, horafinreservacion, SUM(numerousuarios) AS usuarios_atendidos,
    ROW_NUMBER() OVER (PARTITION BY DATEDIFF(fechainicioreservacion, _fechainicioreservacion) - WEEKDAY(fechainicioreservacion), 
    DATEDIFF(fechafinreservacion, _fechafinreservacion) - WEEKDAY(fechafinreservacion) ORDER BY idreservacion) AS row_num, aula_procedencia, idlaboratorio, mod1, mod2, mod3, mod4
    FROM reservaciones
    WHERE codigoreservacion = _codigoreservacion
    GROUP BY codigounico_identificador, codigoreservacion, ciclo, nombrereservacion, seccionreservacion, nombre_otrotitular, DATEDIFF(fechainicioreservacion, _fechainicioreservacion) - WEEKDAY(fechainicioreservacion), DATEDIFF(fechafinreservacion, _fechafinreservacion) - WEEKDAY(fechafinreservacion), horainicioreservacion, horafinreservacion, aula_procedencia, idlaboratorio, mod1, mod2, mod3, mod4
) AS subquery
LEFT JOIN usuarios ON (subquery.nombre_otrotitular = '' OR subquery.nombre_otrotitular IS NULL) AND subquery.codigounico_identificador = usuarios.idusuarios
GROUP BY subquery.codigounico_identificador, subquery.codigoreservacion, subquery.ciclo, subquery.nombrereservacion, subquery.seccionreservacion, subquery.nombre_otrotitular;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
--
-- Final view structure for view `vista_generarinformereservacionesprocesadas`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_generarinformereservacionesprocesadas` AS select `reservaciones`.`idusuarios` AS `idusuarios`,`reservaciones`.`idfacultad` AS `idfacultad`,`reservaciones`.`idescuela` AS `idescuela`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`idtiporeservacion` AS `idtiporeservacion`,`facultades`.`nombrefacultad` AS `nombrefacultad`,`escuelas`.`nombre_escuela` AS `nombre_escuela`,`tipo_reservaciones`.`tiporeservacion` AS `tiporeservacion`,case when coalesce(nullif(`reservaciones`.`nombre_otrotitular`,''),'') = '' then concat(`usuarios`.`nombres`,' ',`usuarios`.`apellidos`) else `reservaciones`.`nombre_otrotitular` end AS `nombre_otrotitular`,`reservaciones`.`codigounico_identificador` AS `codigounico_identificador`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`reservaciones`.`aula_procedencia` AS `aula_procedencia`,`reservaciones`.`ciclo` AS `ciclo`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`seccionreservacion` AS `seccionreservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`fechafinreservacion` AS `fechafinreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`numerousuarios` AS `numerousuarios`,`reservaciones`.`estadoreservacion` AS `estadoreservacion`,`reservaciones`.`otrotipo_reservacion` AS `otrotipo_reservacion`,`reservaciones`.`mod1` AS `mod1`,`reservaciones`.`mod2` AS `mod2`,`reservaciones`.`mod3` AS `mod3`,`reservaciones`.`mod4` AS `mod4` from ((((`reservaciones` join `facultades` on(`reservaciones`.`idfacultad` = `facultades`.`idfacultad`)) join `escuelas` on(`reservaciones`.`idescuela` = `escuelas`.`idescuela`)) join `tipo_reservaciones` on(`reservaciones`.`idtiporeservacion` = `tipo_reservaciones`.`idtiporeservacion`)) left join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-05-24 18:48:18
