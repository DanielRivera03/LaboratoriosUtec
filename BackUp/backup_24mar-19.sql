...
INSERT INTO `reservaciones` VALUES (1,1,1,3,17,1,'BAS1-I','Base de Datos I',1,'2023-03-27','2023-03-30','06:30:00','08:00:00',68,'pendiente',1);
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_ConsultaDisponibilidadReservaciones`(IN `_idaplicacion` INT, IN `_totalusuarios` INT, IN `_fechafinreservacion` DATE, IN `_fechainicioreservacion` DATE, IN `_horafinreservacion` TIME, IN `_horainicioreservacion` TIME)
BEGIN
SELECT 
...
-- Dump completed on 2023-03-24 18:58:13
