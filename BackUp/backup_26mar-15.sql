...
LEFT JOIN (
    ...
    WHERE 
        ...
        ((horainicioreservacion >= _horainicioreservacion AND horainicioreservacion < _horafinreservacion) OR (horafinreservacion > _horainicioreservacion AND horafinreservacion <= _horafinreservacion))
...
-- Dump completed on 2023-03-26 14:58:32
