...
INSERT INTO `usuarios` VALUES (1,1,'Daniel','Rivera','daniel.rivera','dieselmods1@gmail.com','icon-fotoperfildefecto.gif','$argon2i$v=19$m=65536,t=4,p=2$U3lObEhHZHd4aWt2T3B6aw$mqXlpi6PejjOgffNSNNvxXDeBx2gUZ2FH5kTy4aQSpw','si','2023-03-30 10:37:10','activo','si','no','no','no','no','no','no','no','si','no','no','no','no','no','no','si','2023-02-28 20:47:12'),(2,1,'Kevin','Rivera','kevin.rivera','2734002018@mail.utec.edu.sv','icon-fotoperfildefecto.gif','$argon2i$v=19$m=65536,t=4,p=2$V3F1V3UwTmRtSlQyOENEbg$v4ER5wPWkhFKkG810eiUcjIwq9I6TtVqJmdRy/J70rQ','si','2023-03-01 21:40:20','activo','si','si','si','si','si','si','si','si','si','si','si','si','si','si','si','si','2023-03-01 21:40:20'),(3,1,'Irving','Dominguez','irving.dominguez','2731812020@mail.utec.edu.sv','icon-fotoperfildefecto.gif','$argon2i$v=19$m=65536,t=4,p=2$V2pnRjVaMDlHeWE5YVVqRw$drPLhhprJO+gdZWOO4DWI9nmQ9E8sbPbCO9qt5lvuOE','si','2023-03-01 21:41:39','activo','si','si','si','si','si','si','si','si','si','si','si','si','si','si','si','si','2023-03-01 21:41:39'),(4,1,'Elias','Martinez','elias.martinez','a@a.com','icon-fotoperfildefecto.gif','$argon2i$v=19$m=65536,t=4,p=2$NVlOd3J0LjRTZFRZclJYUg$BHVTY8NCM50f0gttEoMKV5V1A1IzpW4JwTh9rwx7gSg','si','2023-03-01 21:42:46','activo','si','si','no','no','no','no','no','no','no','no','no','no','no','si','no','si','2023-03-01 21:42:46'),(9,1,'Elias','Martinez','elias.martinezz','proyectosedmr@gmail.com','061611_640665036b8ee_1590693630_image.jpg','$argon2i$v=19$m=65536,t=4,p=2$UkJCUk8zaXJUZVhjbGx2ZQ$ADlmc12hulg3grVXr0AOZk5u2vxjK2y5YFOqPuL/lDM','si','2023-03-01 22:11:35','activo','','','','','','','','','','','','','','','','si','2023-03-01 22:11:35'),(18,1,'Maria DBA','Lorem','mari.lorem','2700772019@mail.utec.edu.sv','icon-fotoperfildefecto.gif','$argon2i$v=19$m=65536,t=4,p=2$eEpDQWV5ZEJualljd2ZHZA$Y1oYN3WxFtBdhDeqRlYKf5xKDBtT7TM6Kl2CR1OCR4Q','si','2023-03-16 21:51:36','activo','si','no','no','no','no','no','no','no','no','no','no','no','no','no','si','si','2023-03-16 21:51:36');
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio10` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 10 limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio11` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 11 limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio12` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 12 limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio13` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 13 limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio14` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 14 limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio15` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 15 limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio2` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 2 limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio3` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 3 limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio4` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 4 limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio5` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 5 limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio6` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 6 limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio7` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 7 limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio8` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 8 limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio9` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 9 limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-04-04  0:44:32
