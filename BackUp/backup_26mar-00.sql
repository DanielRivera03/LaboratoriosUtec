...
INSERT INTO `reservaciones` VALUES (1,1,1,7,3,17,1,'BAS1-I','Base de Datos I',1,'2023-03-27','2023-03-27','06:30:00','07:59:00',68,'pendiente','','0000-00-00 00:00:00'),(2,1,1,7,3,17,1,'BAS1-I','Bases de Datos I',1,'2023-03-31','2023-03-31','06:30:00','07:59:00',76,'pendiente','','0000-00-00 00:00:00'),(3,1,1,7,3,17,1,'BAS1-I','Bases de Datos I',1,'2023-03-27','2023-03-27','08:00:00','09:29:00',65,'pendiente','N/D','2023-03-26 05:51:31'),(4,1,1,7,3,17,1,'BAS1-I','Bases de Datos I',1,'2023-03-31','2023-03-31','08:00:00','09:29:00',65,'pendiente','N/D','2023-03-26 05:51:53'),(5,1,1,7,3,17,1,'BAS1-I','Bases de Datos I',1,'2023-03-27','2023-03-27','09:30:00','10:59:00',65,'pendiente','N/D','2023-03-26 05:53:51'),(6,1,1,7,3,17,1,'BAS1-I','Bases de Datos I',1,'2023-03-31','2023-03-31','09:30:00','10:59:00',65,'pendiente','N/D','2023-03-26 05:54:03'),(7,1,1,7,3,17,1,'BAS1-I','Bases de Datos I',1,'2023-03-27','2023-03-27','14:00:00','15:59:00',65,'pendiente','N/D','2023-03-26 05:55:47'),(8,1,1,7,3,17,1,'BAS1-I','Bases de Datos I',1,'2023-03-31','2023-03-31','14:00:00','15:59:00',65,'pendiente','N/D','2023-03-26 05:55:57'),(9,1,1,7,3,17,1,'BAS1-I','Bases de Datos I',1,'2023-03-27','2023-03-27','16:00:00','18:10:00',65,'pendiente','N/D','2023-03-26 05:57:05'),(10,1,1,7,3,17,1,'BAS1-I','Bases de Datos I',1,'2023-03-31','2023-03-31','16:00:00','18:10:00',65,'pendiente','N/D','2023-03-26 05:57:13'),(11,1,1,7,3,17,1,'BAS1-I','Bases de Datos I',1,'2023-03-27','2023-03-27','18:40:00','20:10:00',65,'pendiente','N/D','2023-03-26 05:57:50'),(12,1,1,7,3,17,1,'BAS1-I','Bases de Datos I',1,'2023-03-31','2023-03-31','18:40:00','20:10:00',65,'pendiente','N/D','2023-03-26 05:58:03');
...
/*!50003 SET sql_mode              = 'NO_ZERO_IN_DATE,NO_ZERO_DATE,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_ConsultaDisponibilidadReservaciones`(IN `_idaplicacion` INT, IN `_totalusuarios` INT, IN `_fechafinreservacion` DATE, IN `_fechainicioreservacion` DATE, IN `_horainicioreservacion` TIME, IN `_horafinreservacion` TIME)
BEGIN
SELECT 
...
LEFT JOIN (
    ...
    WHERE 
        fechafinreservacion >= _fechafinreservacion AND 
        fechainicioreservacion <= _fechainicioreservacion AND 
        horafinreservacion >= _horafinreservacion AND 
        horainicioreservacion <= _horainicioreservacion
...
BEGIN
	INSERT INTO reservaciones (idusuarios,idfacultad,idescuela,idlaboratorio,idaplicacion,
                               ...
                               _idtiporeservacion,_codigoreservacion,_nombrereservacion,_seccionreservacion,_fechainicioreservacion,
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_disponibilidadreservaciones` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`fechafinreservacion` AS `fechafinreservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion` from `reservaciones` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-03-26  0:33:55
