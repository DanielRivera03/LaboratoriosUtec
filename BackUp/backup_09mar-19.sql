...
SELECT * FROM vista_listadonotificacionesrecibidas WHERE idusuarios=_idusuarios ORDER BY fechanotificacion DESC LIMIT 100 ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
...
-- Dump completed on 2023-03-09 19:18:48
