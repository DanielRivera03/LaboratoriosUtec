...
INSERT INTO `reservaciones` VALUES (1,1,1,7,8,19,1,'1-02-2023_23164426-5b267dae','BAS1-I','02-2023','Bases de Datos 1',2,'2023-04-10','2023-04-10','06:30:00','07:59:00',64,'aprobado','N/D',NULL,'ec','2023-04-03 22:44:26'),(2,1,1,7,8,19,1,'1-02-2023_23164426-5b267dae','BAS1-I','02-2023','Bases de Datos 1',2,'2023-04-14','2023-04-14','06:30:00','07:59:00',64,'aprobado','N/D',NULL,'no','2023-04-03 22:44:26'),(3,1,1,7,1,17,1,'1-02-2023_23164601-981e60e2','POO-I','02-2023','Programacion Orientada Objetos',1,'2023-04-10','2023-04-10','08:00:00','09:29:00',78,'aprobado','N/D',NULL,'no','2023-04-03 22:46:01'),(4,1,1,7,1,17,1,'1-02-2023_23164601-981e60e2','POO-I','02-2023','Programacion Orientada Objetos',1,'2023-04-14','2023-04-14','08:00:00','09:29:00',78,'aprobado','N/D',NULL,'no','2023-04-03 22:46:01'),(5,1,1,8,9,33,4,'1-02-2023_23164818-9b410a95','NI','02-2023','NUEVO INGRESO TOUR UTEC',0,'2023-04-10','2023-04-10','08:00:00','10:59:00',38,'aprobado','N/D',NULL,'no','2023-04-03 22:48:18'),(6,1,1,7,9,17,6,'1-02-2023_23165028-72920906','INST-POO','02-2023','Instructoria Programacion Orientada Objetos',0,'2023-04-10','2023-04-10','11:00:00','12:29:00',24,'aprobado','Instructoria',NULL,'no','2023-04-03 22:50:28'),(7,1,3,2,3,4,1,'1-02-2023_23165257-3840dbf5','ESTA-II','02-2023','ESTADISTICA II',4,'2023-04-11','2023-04-11','14:00:00','15:59:00',61,'aprobado','N/D',NULL,'no','2023-04-03 22:52:57'),(8,1,3,2,3,4,1,'1-02-2023_23165257-3840dbf5','ESTA-II','02-2023','ESTADISTICA II',4,'2023-04-13','2023-04-13','14:00:00','15:59:00',61,'aprobado','N/D',NULL,'no','2023-04-03 22:52:57'),(9,1,1,7,6,18,1,'1-02-2023_23165526-4d29755a','DSWI1-I','02-2023','Desarrollo Sistemas Informaticos Web 1',1,'2023-04-12','2023-04-12','06:30:00','07:59:00',40,'aprobado','N/D',NULL,'no','2023-04-03 22:55:26'),(10,1,1,7,6,18,1,'1-02-2023_23165526-4d29755a','DSWI1-I','02-2023','Desarrollo Sistemas Informaticos Web 1',1,'2023-04-15','2023-04-15','06:30:00','07:59:00',40,'aprobado','N/D',NULL,'no','2023-04-03 22:55:26'),(11,1,1,7,1,33,3,'1-02-2023_23165854-b685bde1','F-384','02-2023','GIT Y GITHUB SEMINARIO F-384',0,'2023-04-15','2023-04-15','13:00:00','17:59:00',71,'aprobado','N/D',NULL,'no','2023-04-03 22:58:54'),(12,1,1,7,6,18,1,'1-02-2023_23170044-a575f26b','DPWEB','02-2023','Desarrollo de la Plataforma Web',3,'2023-04-15','2023-04-15','13:00:00','15:59:00',57,'aprobado','N/D',NULL,'no','2023-04-03 23:00:44'),(13,1,1,7,10,13,1,'1-02-2023_23170337-3319c3fc','PROG1-I','02-2023','Programacion I',4,'2023-04-16','2023-04-16','07:00:00','09:59:00',18,'aprobado','N/D',NULL,'no','2023-04-03 23:03:37'),(14,1,1,7,10,19,1,'1-02-2023_23173654-e24eb086','BAS2-I','02-2023','Bases de Datos II',2,'2023-04-16','2023-04-16','10:00:00','12:59:00',49,'aprobado','N/D',NULL,'no','2023-04-03 23:36:54'),(15,1,1,8,9,33,4,'1-02-2023_23174620-6b645865','NI','02-2023','TOUR UTEC',0,'2023-04-14','2023-04-14','09:00:00','11:59:00',35,'aprobado','N/D',NULL,'no','2023-04-03 23:46:20'),(16,1,1,7,8,16,1,'1-02-2023_23234629-50660455','MBD-I','02-2023','Modelado Bases de Datos',1,'2023-04-12','2023-04-12','17:00:00','18:39:00',49,'aprobado','N/D',NULL,'no','2023-04-04 05:46:29'),(17,1,1,7,8,16,1,'1-02-2023_23234629-50660455','MBD-I','02-2023','Modelado Bases de Datos',1,'2023-04-15','2023-04-15','17:00:00','18:39:00',49,'aprobado','N/D',NULL,'no','2023-04-04 05:46:29'),(18,1,1,7,9,4,6,'1-02-2023_23171604-57f9da84','INST-INF1','02-2023','Instructoria Informatica 1',0,'2023-04-11','2023-04-11','09:30:00','11:29:00',47,'aprobado','Instructoria',NULL,'no','2023-04-09 23:16:04');
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio10` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado`,`reservaciones`.`fecharegistro` AS `fecharegistro` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 10 order by `reservaciones`.`fechainicioreservacion`,`reservaciones`.`horainicioreservacion` limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio11` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado`,`reservaciones`.`fecharegistro` AS `fecharegistro` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 11 order by `reservaciones`.`fechainicioreservacion`,`reservaciones`.`horainicioreservacion` limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio12` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado`,`reservaciones`.`fecharegistro` AS `fecharegistro` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 12 order by `reservaciones`.`fechainicioreservacion`,`reservaciones`.`horainicioreservacion` limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio13` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado`,`reservaciones`.`fecharegistro` AS `fecharegistro` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 13 order by `reservaciones`.`fechainicioreservacion`,`reservaciones`.`horainicioreservacion` limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio14` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado`,`reservaciones`.`fecharegistro` AS `fecharegistro` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 14 order by `reservaciones`.`fechainicioreservacion`,`reservaciones`.`horainicioreservacion` limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio15` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado`,`reservaciones`.`fecharegistro` AS `fecharegistro` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 15 order by `reservaciones`.`fechainicioreservacion`,`reservaciones`.`horainicioreservacion` limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio2` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado`,`reservaciones`.`fecharegistro` AS `fecharegistro` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 2 order by `reservaciones`.`fechainicioreservacion`,`reservaciones`.`horainicioreservacion` limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio3` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado`,`reservaciones`.`fecharegistro` AS `fecharegistro` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 3 order by `reservaciones`.`fechainicioreservacion`,`reservaciones`.`horainicioreservacion` limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio4` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado`,`reservaciones`.`fecharegistro` AS `fecharegistro` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 4 order by `reservaciones`.`fechainicioreservacion`,`reservaciones`.`horainicioreservacion` limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio5` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado`,`reservaciones`.`fecharegistro` AS `fecharegistro` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 5 order by `reservaciones`.`fechainicioreservacion`,`reservaciones`.`horainicioreservacion` limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio6` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado`,`reservaciones`.`fecharegistro` AS `fecharegistro` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 6 order by `reservaciones`.`fechainicioreservacion`,`reservaciones`.`horainicioreservacion` limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio7` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado`,`reservaciones`.`fecharegistro` AS `fecharegistro` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 7 order by `reservaciones`.`fechainicioreservacion`,`reservaciones`.`horainicioreservacion` limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio8` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado`,`reservaciones`.`fecharegistro` AS `fecharegistro` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 8 order by `reservaciones`.`fechainicioreservacion`,`reservaciones`.`horainicioreservacion` limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `vista_proximareservacionlabotatorio9` AS select `reservaciones`.`idreservacion` AS `idreservacion`,`reservaciones`.`idlaboratorio` AS `idlaboratorio`,`reservaciones`.`codigoreservacion` AS `codigoreservacion`,`usuarios`.`nombres` AS `nombres`,`usuarios`.`apellidos` AS `apellidos`,`reservaciones`.`nombrereservacion` AS `nombrereservacion`,`reservaciones`.`fechainicioreservacion` AS `fechainicioreservacion`,`reservaciones`.`horainicioreservacion` AS `horainicioreservacion`,`reservaciones`.`horafinreservacion` AS `horafinreservacion`,`reservaciones`.`finalizado` AS `finalizado`,`reservaciones`.`fecharegistro` AS `fecharegistro` from (`reservaciones` join `usuarios` on(`reservaciones`.`idusuarios` = `usuarios`.`idusuarios`)) where (`reservaciones`.`finalizado` = 'no' or `reservaciones`.`finalizado` = 'ec') and `reservaciones`.`idlaboratorio` = 9 order by `reservaciones`.`fechainicioreservacion`,`reservaciones`.`horainicioreservacion` limit 1 */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2023-04-09 18:58:00
