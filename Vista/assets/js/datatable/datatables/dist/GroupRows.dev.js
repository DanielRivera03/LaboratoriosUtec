...
(function ($) {
  ...
  var RowsGroup = function RowsGroup(dt, columnsForGrouping) {
    this.table = dt.table();
    this.columnsForGrouping = columnsForGrouping; // set to True when new reorder is applied by RowsGroup to prevent order() looping
  ...
  $.fn.DataTable.RowsGroup = RowsGroup; // Automatic initialisation listener
...
*/
//# sourceMappingURL=GroupRows.dev.js.map
