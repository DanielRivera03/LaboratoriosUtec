...
$(document).ready(function () {
  $("#frm_registro_nuevos_laboratorios_informatica").on('submit', function (e) {
    // "e" IDENTIFICADOR DE ACCION PARA CAPTURAR EVENTO DE FORMULARIO
    var CodigoLaboratorio = $('#txtcodigo_laboratorio').val(); // CODIGO LABORATORIO

    var NombreLaboratorio = $('#txtnombre_laboratorio').val(); // NOMBRE LABORATORIO

    var CapacidadLaboratorio = $('#txtcapacidad_laboratorio').val(); // CAPACIDAD LABORATORIO
...
//# sourceMappingURL=AJAX_envio-datos-nuevos-laboratorios-informatica.dev.js.map
