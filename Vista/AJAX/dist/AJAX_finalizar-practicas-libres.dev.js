  ...
  swal({
    ...
    if (willDelete) {
      $.ajax({
        ...
        type: 'POST',
        data: 'idpracticalibre=' + IDPracticaLibre,
        // COMPARACION PREVIA ANTES DE EJECUTAR ACCION EN SERVIDOR
        dataType: 'json'
      }).done(function (respuesta) {
        // SI MODELO EJECUTA PETICION, REALIZA PETICION
        if (respuesta == "OK") {
          AlertaUsuarioMostrar("Práctica Finalizada", "Su petición se ha realizado con éxito", "success"); // 2.5 SEGUNDOS DE RETRASO PARA MOSTRAR ALERTA Y REFRESCAR
...
//# sourceMappingURL=AJAX_finalizar-practicas-libres.dev.js.map
