  ...
  swal({
    ...
    if (willDelete) {
      $.ajax({
        ...
        type: 'POST',
        data: 'idnotificacion=' + IDNotificaciones,
        // COMPARACION PREVIA ANTES DE EJECUTAR ACCION EN SERVIDOR
        dataType: 'json'
      }).done(function (respuesta) {
        // SI MODELO EJECUTA PETICION, REALIZA PETICION
        if (respuesta == "OK") {
          AlertaUsuarioMostrar("Notificación Oculta", "Su petición se ha realizado con éxito", "info"); // 2.5 SEGUNDOS DE RETRASO PARA MOSTRAR ALERTA Y REFRESCAR
...
//# sourceMappingURL=AJAX_Ocultar-notificaciones-usuarios.dev.js.map
