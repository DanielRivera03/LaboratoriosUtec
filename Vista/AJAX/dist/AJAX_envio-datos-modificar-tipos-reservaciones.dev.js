...
$(document).ready(function () {
  $("#frm_registro_modificar_tipos_reservaciones").on('submit', function (e) {
    // "e" IDENTIFICADOR DE ACCION PARA CAPTURAR EVENTO DE FORMULARIO
    var IdTipoReservacion = $('#txtid_tipos_reservaciones').val(); // ID TIPO RESERVACION

    var NombreTipoReservacion = $('#txtnombre_tiporeservacion').val(); // NOMBRE TIPO RESERVACION

    var DescripcionTipoReservacion = $('#txtdescripcion_tiporeservacion').val(); // DESCRIPCION TIPO RESERVACION
...
//# sourceMappingURL=AJAX_envio-datos-modificar-tipos-reservaciones.dev.js.map
