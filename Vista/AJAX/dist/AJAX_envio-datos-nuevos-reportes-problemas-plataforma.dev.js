...
$(document).ready(function () {
  $("#frm_registro_nuevos_roles_usuarios").on('submit', function (e) {
    ...
    var NombreReporte = $('#txtnombre_reporteplataforma').val(); // NOMBRES DE REPORTES

    var DescripcionReporte = $('#txtdescripcion_reporteplataforma').val(); // DESCRIPCION DE REPORTES

    var FotoReporte = $('#input-file-max-fs').val(); // FOTOS DE REPORTES
...
//# sourceMappingURL=AJAX_envio-datos-nuevos-reportes-problemas-plataforma.dev.js.map
