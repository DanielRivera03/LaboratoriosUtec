  ...
  swal({
    ...
    if (willDelete) {
      $.ajax({
        ...
        if (respuesta == "OK") {
          AlertaUsuarioMostrar("Usuario Activado", "Su petición se ha realizado con éxito", "success"); // 2.5 SEGUNDOS DE RETRASO PARA MOSTRAR ALERTA Y REFRESCAR
...
//# sourceMappingURL=AJAX_activar-usuarios.dev.js.map
