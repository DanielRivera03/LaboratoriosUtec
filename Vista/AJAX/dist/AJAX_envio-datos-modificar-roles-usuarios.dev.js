...
$(document).ready(function () {
  $("#frm_registro_modificar_roles_usuarios").on('submit', function (e) {
    // "e" IDENTIFICADOR DE ACCION PARA CAPTURAR EVENTO DE FORMULARIO
    var IdRolUsuario = $('#txtidrolusuario').val(); // ID ROL DE USUARIO
...
//# sourceMappingURL=AJAX_envio-datos-modificar-roles-usuarios.dev.js.map
