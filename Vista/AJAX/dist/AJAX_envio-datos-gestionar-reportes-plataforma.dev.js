...
$(document).ready(function () {
  $("#frm_gestionar_reportes_plataforma").on('submit', function (e) {
    // "e" IDENTIFICADOR DE ACCION PARA CAPTURAR EVENTO DE FORMULARIO
    var IdReporte = $('#txtid_reporteplataforma').val(); // ID REPORTE

    var EstadoReporte = $('#txtnombre_rolesusuarios').val(); // ESTADO REPORTE

    var ComentarioActualizacionReporte = $('#txtdescripcionactualizacion_reporteplataforma').val(); // DESCRIPCION ACTUALIZACION REPORTE
...
//# sourceMappingURL=AJAX_envio-datos-gestionar-reportes-plataforma.dev.js.map
