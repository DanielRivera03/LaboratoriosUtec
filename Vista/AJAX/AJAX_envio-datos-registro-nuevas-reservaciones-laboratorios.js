$(document).ready(function(){
    $("#frm_reservaciones_segundafase").on('submit',(function(e){ // "e" IDENTIFICADOR DE ACCION PARA CAPTURAR EVENTO DE FORMULARIO
        let AplicacionReservacion = $('#txtAplicacionReservacion').val(); // APLICACION SELECCIONADA
        let FechaInicioReservacion = $('#txtFechaInicioReservacion').val(); // FECHA INICIO 
        let FechaFinReservacion = $('#txtFechaFinReservacion').val(); // FECHA FINALIZACION
        let HoraInicioReservacion = $('#txtHoraInicioReservacion').val(); // HORA INICIO
        let HoraFinReservacion = $('#txtHoraFinReservacion').val(); // HORA FINALIZACION
        let CantidadPersonasReservacion = $('#txtNumeroUsuariosReservacion').val(); // CANTIDAD PERSONAS ASISTIR
        let VerificarTipoReservacionInicial = $('#txtVerificacionTipoReservacionInicial').val(); // VERIFICAR TIPO DE RESERVACION INICIAL
        let SeleccionLaboratorioReservacion = $('#sltlaboratorio_reservacion').val(); // SELECCIONAR LABORATORIO OFERTA SUGERIDA
        let SeleccionTipoReservacion = $('#slttipo_reservacion').val(); // SELECCIONAR TIPO DE RESERVACION
        let SeleccionFacultadReservacion = $('#sltfacultad_reservacion').val(); // SELECCIONAR FACULTAD
        let SeleccionEscuelaReservacion = $('#sltescuela_reservacion').val(); // SELECCIONAR ESCUELA
        let CodigoReservacion = $('#txtCodigoReservacion').val(); // CODIGO RESERVACION
        let NombreReservacion = $('#txtNombreReservacion').val(); // NOMBRE RESERVACION
        let SeccionReservacion = $('#txtSeccionReservacion').val(); // SECCION RESERVACION
        let TitularReservacion = $('#slttitular_reservacion').val(); // VERIFICAR SI ES TITULAR DE RESERVACION
