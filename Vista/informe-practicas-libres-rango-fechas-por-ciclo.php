...
$pdf->Ln(15);
$pdf->MultiCell(633,5,utf8_decode("Estimado(a) ".$PrimerNombre[0].", usted ha solicitado el respectivo informe de prácticas libres procesadas y finalizadas en el ciclo ".$Ciclo.". A continuación le mostramos el detalle general:"));
$pdf->Ln(5);
