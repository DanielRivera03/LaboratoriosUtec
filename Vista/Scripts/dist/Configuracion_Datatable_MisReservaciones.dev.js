...
tabladata = $("#consulta-mis-reservaciones-cicloactual-registradas").DataTable({
  ...
  buttons: [{
    ...
    customize: function customize(doc) {
      ...
      doc.defaultStyle.fontSize = 8.5; // Ajustar la orientación de página a landscape
...
var estadoSelect = $('#estado-select'); // Agregar un listener para detectar cambios en el select

estadoSelect.on('change', function () {
  // Obtener el valor seleccionado
  var estadoSeleccionado = estadoSelect.val(); // Filtrar las filas de la tabla según el estado seleccionado

  var filtroEstado = {
    search: estadoSeleccionado
  };
  tabladata.columns(4).search(estadoSeleccionado); // Mover las filas que cumplen el filtro a la primera página
...
//# sourceMappingURL=Configuracion_Datatable_MisReservaciones.dev.js.map
