...
var tabladata;
tabladata = $("#accesos-usuarios-registrados").DataTable({
  responsive: true,
  ordering: true,
  dom: 'BfrZltip',
  order: [[1, 'desc']],
  buttons: [{
    ...
    title: 'Consolidado Consolidado Mis Accesos Registrados',
    ...
    title: 'Consolidado Mis Accesos Registrados',
    exportOptions: {
      columns: [0, 1, 2, 3]
    }
  }, {
    ...
    title: 'Consolidado Usuarios Registrados',
    titleAttr: 'Imprimir',
...
//# sourceMappingURL=Configuracion_Datatable_AccesosMiPerfil.dev.js.map
