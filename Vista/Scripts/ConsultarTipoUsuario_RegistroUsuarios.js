...
function ValidacionTipoUsuarios(){
    ...
    if(document.getElementById("sltroles_usuarios").value == 1){
        ...
        // SI SELECCION ES DOS -> DEBEN DE SELECCIONAR LOS LABORATORIOS QUE TIENE ASIGNADO DICHO USUARIO
        let AlertaUsuarios = '<div class="alert alert-warning outline fade show" role="alert">* Por favor seleccione los laboratorios que este usuario tiene asignado.</p></div>';
        document.getElementById('aviso_usuarios').innerHTML = AlertaUsuarios;
