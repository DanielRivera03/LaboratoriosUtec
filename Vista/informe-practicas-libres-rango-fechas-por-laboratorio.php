...
$pdf->AliasNbPages();
$pdf->AddPage('L', array(300, 622));
// CONTENIDO DE REPORTE [DOCUMENTO]
$pdf->SetFont('Arial','',13);
$pdf->Ln(20);
$pdf->MultiCell(595,5,utf8_decode("San Salvador, ".utf8_encode(strftime("%A %d de %B de %Y")).""),'','R');
$pdf->Ln(15);
$pdf->MultiCell(595,5,utf8_decode("Estimado(a) ".$PrimerNombre[0].", usted ha solicitado el respectivo informe de prácticas libres procesadas y finalizadas en el rango de fechas desde ".$FechaInicio." hasta ".$FechaFin." filtrado exclusivamente a mostrar el laboratorio ".$IdLaboratorio." de informática. A continuación le mostramos el detalle general:"));
$pdf->Ln(5);
...
$pdf->SetFont('Arial','',13);
$pdf->Ln(5);
$pdf->MultiCell(595,5,utf8_decode("* En base a todas las prácticas libres procesadas, a continuación se desglosa información de interés respecto a todos los registros. Tome en consideración que acá se muestran únicamente los registros procesados del laboratorio ".$IdLaboratorio." de informática."));
$pdf->Ln(3);
...
$pdf->SetFont('Arial','',13);
$pdf->Ln(5);
$pdf->MultiCell(595,5,utf8_decode("* Este informe ha sido generado el: ".date("d-m-Y"))." a las ".date("H:i:s").".");
