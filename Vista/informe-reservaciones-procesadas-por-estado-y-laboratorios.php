...
$pdf = new PDF();
$pdf->SetTitle("Informe Reservaciones Procesadas (Por Estado y Laboratorio)");
$pdf->AliasNbPages();
...
$pdf->Ln(15);
$pdf->MultiCell(988,5,utf8_decode("Estimado(a) ".$PrimerNombre[0].", usted ha solicitado el respectivo informe de reservaciones procesadas en el rango del ciclo ".$Ciclo." mostrando registros filtrados en el laboratorio ".$IdLaboratorio." de informática. Tome en consideración si los respectivos módulos aparecen vacíos, quiere decir que ese laboratorio en cuestión no maneja el servicio por módulos. A continuación le mostramos el detalle general:"));
$pdf->Ln(5);
