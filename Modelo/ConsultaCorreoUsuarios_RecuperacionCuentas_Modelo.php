<?php 
    ...
    **************************************************/
    ...
    if(!empty($_POST["txtcorreoconsulta_recuperaciones"])) {
        $resultado=mysqli_query($conectarsistema,"CALL sp_ConsultarExistenciaUsuarios_RecuperacionCuentas('".$_POST["txtcorreoconsulta_recuperaciones"] ."');");
